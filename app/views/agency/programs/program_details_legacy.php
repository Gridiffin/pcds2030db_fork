<?php
/**
 * Program Details View - Legacy Redirect
 * 
 * Redirects to the new modular program details implementation
 */

// Get program ID and source parameters
$program_id = isset($_GET['id']) ? intval($_GET['id']) : 0;
$source = isset($_GET['source']) ? $_GET['source'] : '';

// Build redirect URL
$redirect_url = 'program_details_new.php?id=' . $program_id;
if ($source) {
    $redirect_url .= '&source=' . urlencode($source);
}
...
// Disable header_config in base.php since we'll render it manually in the right position
