<?php
/**
 * Agency Dashboard - Bento Grid Version
 * 
...
<section class="section">
    <div class="container-fluid">
        ...
        <!-- REMOVE the entire <div class="bento-card size-12x1 mb-4"> ... </div> block that contains the 'include assigned program' filter and its note -->
