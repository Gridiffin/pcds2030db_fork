<?php
/**
 * View Outcome Details (Enhanced for Flexible Structures)
 * 
 * Agency page to view outcome details with support for flexible table structures
 */
...
if ($is_flexible) {
    ...
    $metric_names = array_column($columns, 'id');
} else {
                                            ...
                                            <?php if (in_array($column['type'], ['number', 'currency'])): ?>
                                                <?php
                                                    ...
                                                    foreach ($table_data as $row_data) {
                                                        if ($row_data['row']['type'] === 'data' && isset($row_data['metrics'][$column['id']])) {
                                                            $total += floatval($row_data['metrics'][$column['id']]);
                                                        }
                                                    }
                                                    if ($column['type'] === 'currency') {
