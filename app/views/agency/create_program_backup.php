...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('createProgramForm').addEventListener('submit', function(e) {
            ...
            // Also, for non-drafts, validate description from the second event listener logic
            if (!e.submitter || !e.submitter.name || e.submitter.name !== 'save_draft') {
                ...
                // Check description for non-draft submissions
                const description = document.getElementById('description').value.trim();
                if (!description) {
                    alert('Program Description is required for final submission.');
                    e.preventDefault();
                    return false;
                }
            }
