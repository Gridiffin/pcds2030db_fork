 ...
 * No gradients, minimal animations, clean structure
 */
...
$nav_items = [
    ...
    [
        ...
        'active_pages' => ['view_programs.php', 'create_program.php', 'edit_program.php', 'program_details.php', 'view_submissions.php', 'add_submission.php', 'edit_submission.php', 'delete_program.php']
    ],
    [
        'url' => APP_URL . '/app/views/agency/initiatives/initiatives.php',
        'label' => 'Initiatives',
        'icon' => 'fas fa-lightbulb',
        'active_pages' => ['initiatives.php', 'view_initiative.php']
    ],
    [
...
<nav class="navbar-modern fixed-top" role="navigation" aria-label="Main navigation">
    <div class="navbar-container">
        <!-- Brand Section -->
        <a href="<?php echo APP_URL; ?>/app/views/agency/dashboard/dashboard.php" 
           ...
           aria-label="<?php echo APP_NAME; ?> Home">
            <span class="brand-text" 
                  ...
                  data-ultra-short-text="PCDS"><?php echo APP_NAME; ?></span>
        </a>
        ...
        <div class="navbar-actions-modern">
            ...
            <a href="<?php echo APP_URL; ?>/app/views/agency/reports/public_reports.php" 
               class="nav-link-modern <?php echo $current_page == 'public_reports.php' ? 'active' : ''; ?>" 
               title="Public Reports"
               aria-label="Public Reports">
                <i class="fas fa-file-download nav-icon" aria-hidden="true"></i>
                <span class="sr-only">Public Reports</span>
            </a>
            ...
            <div class="navbar-notifications">
                ...
                <div class="notifications-dropdown" role="menu" aria-labelledby="notifications-toggle">
                    ...
                    <div class="notifications-footer">
                        <a href="<?php echo APP_URL; ?>/app/views/agency/users/all_notifications.php">
