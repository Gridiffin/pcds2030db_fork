    ...
    <div class="container-fluid px-4">        <a class="navbar-brand" href="<?php echo APP_URL; ?>/app/views/agency/dashboard/dashboard.php" 
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php if (in_array($current_page, ['submit_outcomes.php', 'create_outcome_flexible.php', 'create_outcome.php', 'view_outcome.php', 'edit_outcomes.php', 'create_outcomes_detail.php', 'update_metric_detail.php'])) echo 'active'; ?>" href="<?php echo APP_URL; ?>/app/views/agency/outcomes/submit_outcomes.php">
