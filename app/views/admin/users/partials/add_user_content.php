<?php
/**
 * Add User Content Partial
 * 
 * Main content for the add user page
 */
?>
    ...
    if (roleSelect && agencyFields) {
        ...
        function updateAgencyGroupOptions() {
            ...
            agencies.forEach(agency => {
                ...
                if (!selectedSectorId || parseInt(agency.<?php echo $agencyIdCol; ?>) === parseInt(selectedSectorId)) {
                    const option = new Option(agency.<?php echo $agencyNameCol; ?>, agency.<?php echo $agencyIdCol; ?>);
                    agencyId.add(option);
                }
            });
