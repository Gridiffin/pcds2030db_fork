            ...
            <form method="get" class="row g-3">
                ...
                <div class="col-md-4 d-flex align-items-end">
                    ...
                    <?php if ($selected_sector > 0 || $selected_period > 0): ?>
                        <a href="<?php echo APP_URL; ?>/app/views/admin/manage_metrics.php" class="btn btn-outline-secondary">Clear Filters</a>
                    <?php endif; ?>
                </div>
            </form>
        </div>
                    ...
                    <?php else: ?>
                        <?php foreach ($display_metrics as $metric): ?>
                            <tr data-metric-id="<?php echo $metric['metric_id']; ?>">
                                ...
                                <td>
                                    <a href="<?php echo APP_URL; ?>/app/views/admin/unsubmit.php?metric_id=<?php echo $metric['metric_id']; ?>" class="btn btn-sm btn-warning me-1" role="button" onclick="return confirm('Are you sure you want to unsubmit?');">
                                    ...
                                    <a href="<?php echo APP_URL; ?>/app/views/admin/edit_metric.php?metric_id=<?php echo $metric['metric_id']; ?>" class="btn btn-sm btn-primary me-1" role="button">
                                        <i class="fas fa-edit me-1"></i> Edit
                                    </a>                                    <a href="<?php echo APP_URL; ?>/app/views/admin/delete_metric.php?metric_id=<?php echo $metric['metric_id']; ?>" class="btn btn-sm btn-danger" role="button" onclick="return confirm('Are you sure you want to delete this outcome?');">
