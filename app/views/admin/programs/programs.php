 ...
 * Admin View Programs
 * 
 * Interface for admin users to view and manage all programs across agencies.
 */
...
// Additional scripts - Admin programs management
$additionalScripts = [
    APP_URL . '/assets/js/admin/programs_delete.js', // Delete and more actions functionality
        ...
        <div class="table-responsive">            <table class="table table-hover table-custom mb-0" id="finalizedProgramsTable">
                ...
                <tbody>
                    <?php if (empty($programs_with_submissions)): ?>
                        <tr>
                            <td colspan="6" class="text-center py-4">No programs with finalized submissions found.</td>
                        </tr>
                    <?php else: ?>
...
<!-- Bootstrap and other scripts are loaded in footer.php -->
<?php
// Include footer
