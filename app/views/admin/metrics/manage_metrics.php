                        ...
                        <?php foreach ($display_outcomes as $outcome): ?>                            <tr data-outcome-id="<?php echo $outcome['metric_id']; ?>">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm" role="group">
                                        <a href="<?php echo APP_URL; ?>/app/views/admin/outcomes/unsubmit_outcome.php?outcome_id=<?php echo $outcome['metric_id']; ?>" class="btn btn-forest-light btn-sm me-1" role="button" onclick="return confirm('Are you sure you want to unsubmit this outcome?');">
                                            <i class="fas fa-undo me-1"></i> Unsubmit
                                        </a>
                                        <a href="outcomes/view_outcome.php?outcome_id=<?php echo $outcome['metric_id']; ?>" class="btn btn-forest-light btn-sm me-1" role="button">
                                            <i class="fas fa-eye me-1"></i> View
                                        </a>
                                        <a href="<?php echo APP_URL; ?>/app/views/admin/outcomes/edit_outcome.php?outcome_id=<?php echo $outcome['metric_id']; ?>" class="btn btn-forest btn-sm me-1" role="button">
                                            <i class="fas fa-edit me-1"></i> Edit
                                        </a>
                                        <a href="<?php echo APP_URL; ?>/app/views/admin/outcomes/delete_outcome.php?outcome_id=<?php echo $outcome['metric_id']; ?>" class="btn btn-forest-light btn-sm text-danger" role="button" onclick="return confirm('Are you sure you want to delete this outcome?');">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('createOutcomeBtn').addEventListener('click', function() {
            ...
            let url = 'outcomes/edit_outcome.php'; // Changed from edit_metric.php
            let params = [];
