...
return [
    ...
    'program_submissions' => [
        'columns' => [
            ...
            'is_draft' => ['type' => 'tinyint', 'length' => 1, 'nullable' => false, 'default' => 1],
            'is_submitted' => ['type' => 'tinyint', 'length' => 1, 'nullable' => false, 'default' => 0],
            'status_indicator' => ['type' => 'enum', 'values' => ['not_started','in_progress','completed','delayed'], 'nullable' => false, 'default' => 'not_started'],
            'rating' => ['type' => 'enum', 'values' => ['monthly_target_achieved','on_track_for_year','severe_delay','not_started'], 'nullable' => false, 'default' => 'not_started'],
            'description' => ['type' => 'text', 'nullable' => true],
            'start_date' => ['type' => 'date', 'nullable' => true],
            'end_date' => ['type' => 'date', 'nullable' => true],
            'submitted_by' => ['type' => 'int', 'nullable' => true],
            'submitted_at' => ['type' => 'timestamp', 'nullable' => true],
            'updated_at' => ['type' => 'timestamp', 'nullable' => false, 'default' => 'CURRENT_TIMESTAMP', 'on_update' => 'CURRENT_TIMESTAMP'],
            'is_deleted' => ['type' => 'tinyint', 'length' => 1, 'nullable' => false, 'default' => 0],
        ],
    ],
    'program_targets' => [
        'columns' => [
            ...
            'status_indicator' => ['type' => 'enum', 'values' => ['not_started','in_progress','completed','delayed'], 'nullable' => false, 'default' => 'not_started'],
            'status_description' => ['type' => 'text', 'nullable' => true],
