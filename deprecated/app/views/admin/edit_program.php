...
require_once ROOT_PATH . 'app/lib/$((includes/admin_functions.php -replace 'includes/', ''))';
require_once ROOT_PATH . 'app/lib/$((includes/rating_helpers.php -replace 'includes/', ''))';
require_once ROOT_PATH . 'app/lib/$((includes/agencies/programs.php -replace 'includes/', ''))'; // Added for program history feature
