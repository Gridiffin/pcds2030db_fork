...
class Container_cae8743136 extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_cae8743136 $container)
			{
	...
	public function createServiceContainer(): Container_cae8743136
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludePaths' => null,
			'level' => 5,
			'paths' => ['C:\laragon\www\pcds2030_dashboard_fork\app', 'C:\laragon\www\pcds2030_dashboard_fork\live'],
			'exceptions' => [
				'implicitThrows' => true,
