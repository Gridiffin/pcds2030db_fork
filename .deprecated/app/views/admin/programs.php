...
require_once ROOT_PATH . 'app/lib/$((includes/rating_helpers.php -replace 'includes/', ''))'; // For rating badge display
require_once ROOT_PATH . 'app/lib/$((includes/admins/statistics.php -replace 'includes/', ''))'; // For get_admin_program_details function
...
<?php require_once ROOT_PATH . 'app/lib/$((includes/period_selector.php -replace 'includes/', ''))'; ?>
