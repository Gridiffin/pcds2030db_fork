                    ...
                    <?php else: ?>
                        <?php foreach ($display_metrics as $metric): ?>
                            <tr data-metric-id="<?php echo $metric['metric_id']; ?>">
                                ...
                                <td>
                                    <a href="unsubmit.php?metric_id=<?php echo $metric['metric_id']; ?>" class="btn btn-sm btn-warning me-1" role="button" onclick="return confirm('Are you sure you want to unsubmit?');">
